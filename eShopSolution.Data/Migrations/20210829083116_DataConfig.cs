...
{
    public partial class DataConfig : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    OrderDate = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2021, 8, 29, 15, 31, 15, 883, DateTimeKind.Local).AddTicks(9485)),
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: true),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2021, 8, 29, 15, 31, 15, 896, DateTimeKind.Local).AddTicks(8923), 300000m, 400000m });
